...
import 'user_login.dart' as _i15;
import 'user_room.dart' as _i16;
import 'vehicles.dart' as _i17;
import 'package:thj_client/src/protocol/area.dart' as _i18;
import 'package:thj_client/src/protocol/city.dart' as _i19;
import 'package:thj_client/src/protocol/country.dart' as _i20;
import 'package:thj_client/src/protocol/district.dart' as _i21;
import 'package:thj_client/src/protocol/state.dart' as _i22;
import 'package:thj_client/src/protocol/members.dart' as _i23;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i14.State) {
      return _i14.State.fromJson(data, this) as T;
    }
    if (t == _i15.UserLogin) {
      return _i15.UserLogin.fromJson(data, this) as T;
    }
    if (t == _i16.UserRoom) {
      return _i16.UserRoom.fromJson(data, this) as T;
    }
    if (t == _i17.Vehicles) {
      return _i17.Vehicles.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i14.State?>()) {
      return (data != null ? _i14.State.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i15.UserLogin?>()) {
      return (data != null ? _i15.UserLogin.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i16.UserRoom?>()) {
      return (data != null ? _i16.UserRoom.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i17.Vehicles?>()) {
      return (data != null ? _i17.Vehicles.fromJson(data, this) : null) as T;
    }
    if (t == List<int>) {
    ...
    if (t == List<_i22.State>) {
      return (data as List).map((e) => deserialize<_i22.State>(e)).toList()
          as dynamic;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i14.State) {
      return 'State';
    }
    if (data is _i15.UserLogin) {
      return 'UserLogin';
    }
    if (data is _i16.UserRoom) {
      return 'UserRoom';
    }
    if (data is _i17.Vehicles) {
      return 'Vehicles';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'State') {
      return deserialize<_i14.State>(data['data']);
    }
    if (data['className'] == 'UserLogin') {
      return deserialize<_i15.UserLogin>(data['data']);
    }
    if (data['className'] == 'UserRoom') {
      return deserialize<_i16.UserRoom>(data['data']);
    }
    if (data['className'] == 'Vehicles') {
      return deserialize<_i17.Vehicles>(data['data']);
    }
